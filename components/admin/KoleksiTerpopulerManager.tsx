  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-end">
        <button
          onClick={openCreate}
          className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-lg flex items-center gap-2 font-semibold"
        >
            ...
            <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between gap-3">
              ...
              <div className="flex gap-2 pt-2 border-t border-gray-100 dark:border-gray-800 mt-auto">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 text-primary border border-primary/20 bg-primary/5 py-1.5 rounded-lg text-xs font-semibold hover:bg-primary hover:text-white transition-all"
                >
                  <Edit2 size={13} /> Edit
                </button>
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 text-red-600 border border-red-500/20 bg-red-50 dark:bg-red-900/10 py-1.5 rounded-lg text-xs font-semibold hover:bg-red-500 hover:text-white transition-all disabled:opacity-50"
                >
                  {deletingId === item.id ? (
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 w-full max-w-lg rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-4 border-t dark:border-gray-800 flex gap-2 shrink-0">
              <button
                onClick={() => setShowModal(false)}
                className="flex-1 py-2 text-gray-600 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg font-semibold transition-colors"
              >
                Batal
              </button>
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex-1 py-2 text-white bg-primary hover:bg-primary-dark rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
              >
