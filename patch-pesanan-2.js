...
const startStr = `<h3 className="font-bold text-gray-900 mb-4">Rincian Pembayaran</h3>`;
const endStr = `</div>\n          </div>\n        </div>\n      </div>`;

const startIdx = page.indexOf(startStr);
const endIdx = page.indexOf(endStr, startIdx);
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  console.log("Pesanan detail patched successfully!");
} else {
